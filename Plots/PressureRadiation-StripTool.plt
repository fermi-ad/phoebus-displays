...
<databrowser>
  <title>Solar Radiation &amp; Barometric Pressure</title>
  ...
  <axes>
    <axis>
      ...
      <name>Solar Radiation (W/m^2)</name>
    ...
    <axis>
      <visible>true</visible>
      <name>Barometric Pressure (mBar)</name>
      <use_axis_name>true</use_axis_name>
      <use_trace_names>false</use_trace_names>
      <right>true</right>
      <color>
  ...
  <pvlist>
    ...
    <pv>
      <display_name>Barometric Pressure</display_name>
      <visible>true</visible>
      <name>FNAL-AD-ENV-01:BPRESS</name>
      <axis>1</axis>
      <color>
        <red>0</red>
        <green>127</green>
